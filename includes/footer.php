...
?>
 ...
 ?>
                ...
                <div class="col-lg-3 footer-grid-wthree-w3ls">
                    ...
                    <ul class="links">
                        <li>
                            <a href="student/login.php">Students</a>
                        </li>
                        <li>
                ...
                <div class="col-lg-3 footer-grid-wthree-w3ls">
                   <img src="images/resume-highlighter.png" alt=" " class="img-fluid" />
                   
                </div>
            </div>
           <div class="copyright mt-4">
                <p class="copy-right text-center ">&copy; 2021 RESUME MAKER WEBSITE.
                </p>
            </div>
