...
<head>
    ...
    <title>RESUME MAKER WEBSITE-Manage Work Experience or Internships Details</title>
    <!-- CSS -->
            ...
            <div class="row">
                <div class="col">
                    <h3 class="my-3">
                        ...
                        History of Internship Details</h3>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card my-3 no-b">
                    <div class="card-body">
                        <div class="card-title">History of Internship Details</div>
...
?>
                  ...
                  <td><a href="view-experience.php?viewid=<?php echo $row['ID'];?>">View Details</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
