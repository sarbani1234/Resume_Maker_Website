...
<head>
    ...
    <title>RESUME MAKER WEBSITE-History of Uploaded Skills</title>
    <!-- CSS -->
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card my-3 no-b">
                    <div class="card-body">
                        <div class="card-title">History of Skills</div>
...
?>
                  ...
                  <td><?php  echo $row['SkillsUploadDate'];?></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
