            ...
            <div class="user-panel p-3 light mb-2">
                <div>
                    ...
                    <div class="float-left info">
                        <?php
$aid=$_SESSION['resume_maker_aid'];
$ret=mysqli_query($con,"select UserName from tbladmin where ID='$aid'");
...
?>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="total-regstudents.php">
                <i class="icon icon icon-package blue-text s-18"></i> <span>Total Regd Students</span> 
            </a>
