...
<head>
    ...
    <title>RESUME MAKER WEBSITE-History of Updated Languages</title>
    <!-- CSS -->
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card my-3 no-b">
                    <div class="card-body">
                        <div class="card-title">History of Languages</div>
...
?>
                  ...
                  <td><?php  echo $row['LanguagesUploadDate'];?></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
