...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID,FullName from tblstudent where  (Email='$emailcon' || MobileNumber='$emailcon') && Password='$password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['resume_maker_uid']=$ret['ID'];
            ...
            <div class="row">
                ...
                <div class="col-lg-6 p-t-100">
                    <div class="text-white">
                        <h1>Welcome Back</h1>
                        <p class="s-18 p-t-b-20 font-weight-lighter">Hey Buddies Welcome back to RESUME MAKER websitet!</p>
                    </div>
