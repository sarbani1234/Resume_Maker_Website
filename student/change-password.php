...
$query=mysqli_query($con,"select ID from tblstudent where ID='$uid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tblstudent set Password='$newpassword' where ID='$uid'");
...
<html lang="zxx">
<head>
    <title>RESUME MAKER WEBSITE-Change Password</title>
    <!-- CSS -->
...
<?php include_once('includes/header.php');?>
  ...
  <?php
$uid=$_SESSION['resume_maker_uid'];
$ret=mysqli_query($con,"select * from tblstudent where ID='$uid'");
$cnt=1;
