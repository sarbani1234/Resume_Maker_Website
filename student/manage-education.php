...
if(isset($_POST['update']))
  {
    ...
    $query=mysqli_query($con, "update tblresume set SecondaryBoard='$secboard', SecondaryBoardName='$secboardname', SecondaryBoardyop='$secyop',SecondaryBoardper='$secper',SecondaryBoardcgpa='$seccgpa', SSecondaryBoard='$ssecboard', SSecondaryBoardName='$ssecboardname', SSecondaryBoardyop='$ssecyop',SSecondaryBoardper='$ssecper',SSecondaryBoardcgpa='$sseccgpa',GraUni='$grauni', GraUniName='$grauniname', GraUniyop='$grayop',GraUnidper='$graper',GraUnicgpa='$gracgpa',PGUni='$pguni', PGUniName='$pguniname', PGUniyop='$pgyop',PGUniper='$pgper',PGUnicgpa='$pgcgpa',ExtraCurriculars='$extracurr',OtherAchivement='$otherach' where FullName='$stu_name'");
    if ($query) {
...
<head>
    ...
    <title>RESUME MAKER WEBSITE-Manage Education Detail</title>
    <!-- CSS -->
...
<td>   <input class="form-control white_bg" id="10thboardname" name="10thboardname" value="<?php  echo $row['SecondaryBoardName'];?>"  type="text" required='true'></td>
...
<td>   <input class="form-control white_bg" id="12thboardname" name="12thboardname" value="<?php  echo $row['SSecondaryBoardName'];?>"  type="text" required='true'></td>
...
<td>   <input class="form-control white_bg" id="graduationname" name="graduationname" value="<?php  echo $row['GraUniName'];?>"  type="text" required='true'></td>
...
<td>   <input class="form-control white_bg" id="postgraduationname" name="postgraduationname" value="<?php  echo $row['PGUniName'];?>"  type="text" ></td>
