...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con, "select Email from tblstudent where Email='$email' || MobileNumber='$mobno'");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This email or Contact Number already associated with another account";
    }
    else{
    $query=mysqli_query($con, "insert into tblstudent(FullName,Email,DOB,MobileNumber,Gender,Password) value('$fullname','$email','$dob','$mobno','$gender','$password')");
    if ($query) {
...
<head>
    ...
    <title>RESUME MAKER WEBSITE-Sign Up Page</title>
    <!-- CSS -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 p-t-100">
                    <div class="text-white">
                        <h1>Welcome Back</h1>
                        <p class="s-18 p-t-b-20 font-weight-lighter">Welcome back to RESUME MAKER WEBSITE</p>
                    </div>
...
<input type="email" class="form-control form-control-lg no-b" name="email" id="email" placeholder="Enter your email" required="true">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                    <input type="date" name="dob" required="true" placeholder="Enter Your Date of birth" class="form-control form-control-lg no-b">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group has-icon"><i class="icon-user-secret"></i>
