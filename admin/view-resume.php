...
if (strlen($_SESSION['resume_maker_aid']==0)) {
...
<div id="form-container">
  <?php
$vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tblresume where FullName='$vid'");
$cnt=1;
...
?><div id="form-container">
  <h1 id="title">Personal Details</h1>
                                <div class="form-row">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../student/images/<?php echo $row['Images'];?>" width="200" height="150" value="<?php  echo $row['Images'];?>">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td><p style="color: black;"><?php  echo $row['OtherAchivement'];?></p></td>
  ...
  <?php
  $vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tblinternship where FullName='$vid'");
$num=mysqli_num_rows($ret);
$cnt=1;
if($num>0){
while ($row=mysqli_fetch_array($ret)) {
...
<table class="table table-bordered table-hover data-tables">
 ...
 <?php
 $vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tblskills where FullName='$vid'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
$cnt=$cnt+1;
 ...
 <?php
 $vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tblcourse where FullName='$vid'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
<?php } ?>
 ...
 <?php
 $vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tblawards where FullName='$vid'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
<table class="table table-bordered table-hover data-tables">
 ...
 <?php
 $vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tblprojects where FullName='$vid'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
<table class="table table-bordered table-hover data-tables">
 ...
 <?php
 $vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tbl_languages where FullName='$vid'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
$cnt=$cnt+1;
  ...
  <?php
  $vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tblfamily where FullName='$vid'");
$num=mysqli_num_rows($ret);
$cnt=1;
if($num>0){
while ($row=mysqli_fetch_array($ret)) {
