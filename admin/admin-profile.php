...
if (strlen($_SESSION['resume_maker_aid']==0)) {
  ...
  {
    $adminid=$_SESSION['resume_maker_aid'];
...
<html lang="zxx">
<head>
    <title>RESUME MAKER WEBSITE-Admin Profile</title>
    <!-- CSS -->
...
?>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="adminname" name="adminname" placeholder="Admin Name" value="<?php  echo $row['UserName'];?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="regdate" name="regdate" class="form-control" value="<?php  echo $row['AdminLogindate'];?>" readonly='true'>
                                </div>
                               <?php } ?>
