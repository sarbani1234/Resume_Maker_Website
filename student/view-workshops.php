...
<head>
    ...
    <title>RESUME MAKER WEBSITE-View Workshops or Course Details</title>
    <!-- CSS -->
            ...
            <div class="row p-t-b-10 ">
                <div class="col">
                    <h4>
                        ...
                        History of Course/Workshops Details
                    </h4>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body b-b">
                            <p>History of Course/Workshops Details</p>
                        </div>
                        <div class="card-body b-b">                         
 
 <?php
$vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tblcourse where ID='$vid'");
$cnt=1;
