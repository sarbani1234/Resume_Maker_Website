...
<html lang="zxx">
<head>
    <title>RESUME MAKER WEBSITE-Student Dashboard</title>
    <!-- CSS -->
...
{$name= $row['FullName'];} }?>
                            ...
                            <?php 
                    $query=mysqli_query($con,"Select * from  tblresume where FullName='$name'");
$vaccounts=mysqli_num_rows($query);
?>
                            <h5 class="font-weight-normal s-14">Total Resume</h5>
