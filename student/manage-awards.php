            ...
            <div class="row">
                <div class="col">
                    <h3 class="my-3">
                        ...
                        History of Awards or Certification Details</h3>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card my-3 no-b">
                    <div class="card-body">
                        <div class="card-title">History of Awards or Certification Details</div>
                  ...
                  <th>Competition Date</th>
                    <th>Awards or Certification Upload Date</th>       
                   <th>Action</th>
                </tr>
                            </thead>
                            <tbody>
...
?>
                  ...
                  <td><a href="view-awards.php?viewid=<?php echo $row['ID'];?>">View Details</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
